namespace PpeManager.Api.Application.DTO
{
    public class PpePossessionDTO
    {
        ...
        {
            return ppe != null ? new PpePossessionDTO(ppe.Id, ppe.PpeCertificationId, ppe.DeliveryDate.ToString(new CultureInfo("pt-BR")), ppe.Validity.ToString(new CultureInfo("pt-BR")), ppe.Confirmation, ppe.SupportingDocument, ppe.Quantity): null;
        }
